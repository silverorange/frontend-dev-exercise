...
page at `index.html`. No mockups are provided, use your judgement and the base styles provided in `style.css`. This implementation should have [newly available baseline support](https://web-platform-dx.github.io/web-features/):
